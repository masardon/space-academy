...
Views.about = (params) => {
  ...
  main.innerHTML = `
    <div class="view">
      ...
      <div class="card" style="margin-bottom:16px;">
        <h3 style="font-size:1rem;font-weight:700;margin-bottom:12px;color:var(--accent-light);">${t({ en: "Features", id: "Fitur" })}</h3>
      ...
      <div class="card" style="margin-bottom:16px;">
        ...
        <ul style="display:grid;gap:8px;color:var(--text-secondary);font-size:0.875rem;line-height:1.6;">
          ...
          <li>${t({ en: "Enter your license key (or skip to start with Explorer tier)", id: "Masukkan kunci lisensimu (atau lewati untuk mulai dengan tier Explorer)" })}</li>
      ...
      <div class="card" style="margin-bottom:16px;">
        ...
        <ul style="display:grid;gap:8px;color:var(--text-secondary);font-size:0.875rem;line-height:1.6;">
          <li>${t({ en: "Cheat Sheet & Rust Terms — available on all tiers", id: "Catatan Cepat & Istilah Rust — tersedia di semua tier" })}</li>
          <li>${t({ en: "Wiring Guide, Debug Guide, Analogies, Common Mistakes — Engineer tier and above", id: "Panduan Wiring, Panduan Debug, Analogi, Kesalahan Umum — tier Engineer ke atas" })}</li>
        </ul>
      </div>
      ...
      <div class="card" style="margin-bottom:16px;">
        ...
        <ul style="display:grid;gap:8px;color:var(--text-secondary);font-size:0.875rem;line-height:1.6;">
          ...
          <li>${t({ en: "Add/manage multiple pilots with individual licenses", id: "Tambah/kelola beberapa pilot dengan lisensi masing-masing" })}</li>
          <li>${t({ en: "Change License — update a pilot's tier from Settings", id: "Ubah Lisensi — perbarui tier pilot dari Pengaturan" })}</li>
