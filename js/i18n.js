...
const I18N = {
  ...
  ui: {
    en: {
      ...
      ps_license_already_used: "This license is already used by pilot \"{name}\".",
      ps_license_validated: "License validated!",
      ps_name_taken: "A pilot named \"{name}\" already exists (case-insensitive).",
      ps_update_license_title: "Update License?",
    ...
    id: {
      ...
      ps_license_already_used: "Lisensi ini sudah digunakan oleh pilot \"{name}\".",
      ps_license_validated: "Lisensi terverifikasi!",
      ps_name_taken: "Pilot dengan nama \"{name}\" sudah ada (tidak peka huruf).",
      ps_update_license_title: "Update Lisensi?",
      tier_explorer: "Explorer",
      tier_engineer: "Engineer",
      tier_commander: "Commander",
